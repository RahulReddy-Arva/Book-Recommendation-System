...
We have used AWS cluster to run our application. We are using two different approaches for this project
    ...
    2. Item based Recommendation ( item_recommendation.py )
...
We can either retrieve the files using the  browser or a desktop application called S3 Browser.
 ...
 1. user_recommendation.py :

    The arguments are :  user_recommendation.py, BX-Book-Ratings.csv, Output output_path

    Command:
    $spark-submit s3://bucketname/<user_recommendation.py> s3n://bucketname/<home/cloudera/BX-Book-Ratings.csv> s3n://bucketname/<home/cloudera/user_output>

  2. item_recommendation.py :

  The arguments are :  item_recommendation.py, BX-Book-Ratings.csv, Output output_path

  Command:
  $spark-submit s3://bucketname/<item_recommendation.py> s3n://bucketname/<home/cloudera/BX-Book-Ratings.csv> s3n://bucketname/<home/cloudera/item_output>
